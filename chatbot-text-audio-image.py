...
Falcon_endpoint_name = os.getenv("nlp_ep_name", default="falcon-40b-instruct-12xl")
CV_endpoint_name = os.getenv("cv_ep_name", default="blip2-large-v2")
whisper_endpoint_name = os.getenv('speech_ep_name', default="wisper-large-v2")
    ...
    with container:
        ...
        # when a file is uploaded we also send the content to the chatchain object and ask for confirmation
            ...
            if st.session_state.option == "Audio" and st.session_state.extract_audio:
                ...
                st.session_state['generated'].append(output)
#             elif st.session_state.option == "Computer_Vision":
#                 # image = Image.open(uploaded_file)
#                 # st.markdown('<p style="text-align: center;">uploaded image</p>',unsafe_allow_html=True)
#                 # st.image(image,width=300)
